...
export default function Header({...props}){
  ...
  return (
    <header className={styles.header}>
      ...
      <ul>
        <li>
          <a onClick={() => props.setNav(0)} className={props.navigation === 0 ? styles.navActive : ''}>
        ...
        <li>
          <a onClick={() => props.setNav(1)} className={props.navigation === 1 ? styles.navActive : ''}>
        ...
        <li>
          <a onClick={() => props.setNav(2)} className={props.navigation === 2 ? styles.navActive : ''}>
      ...
      <div className={styles.profile} onClick={() => setToggleProfile(!toggleProfile)}>
